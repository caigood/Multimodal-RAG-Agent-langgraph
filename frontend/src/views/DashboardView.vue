<template>
  <div class="dashboard">
    ...
    <!-- Hero search -->
    <div class="hero">
      <div class="hero-eyebrow">企业知识库工作台</div>
      <h1 class="hero-title">
        随时提问，快速检索你的
        <span class="gradient-text">知识库内容</span>
      </h1>
      ...
      <transition name="slide-up">
        <div v-if="aiAnswer" class="ai-result">
          <div class="ai-result-header">
            <div class="ai-badge"><el-icon><cpu /></el-icon> AI 回答</div>
      ...
      <div class="bento-main">
        ...
        <div class="bento-card collections-card">
          <div class="bento-card-header">
            <span class="bento-card-title">知识库</span>
...
const stats = ref([
  { label: '知识库', value: '—', icon: 'DataAnalysis', color: 'rgba(79,142,247,0.6)' },
  { label: '类目',   value: '—', icon: 'FolderOpened',  color: 'rgba(45,212,160,0.6)' },
  { label: '接口状态', value: '—', icon: 'Connection',    color: 'rgba(167,139,250,0.6)' },
  { label: '当前模型', value: props.currentModel || '—', icon: 'Cpu',           color: 'rgba(245,200,66,0.6)' },
])

watch(() => props.currentModel, (model) => {
  stats.value[3].value = model || '—'
})
